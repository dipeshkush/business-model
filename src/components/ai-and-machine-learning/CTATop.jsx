...
export default function CTATop() {
  ...
  return (
    <div ref={ref} className="text-center py-16 px-4 bg-white">
      ...
      >
        Turn Data Into Decisions with AI That Delivers
      </motion.h2>
      ...
      >
        Build predictive, automated, and intelligent systems with WebSeeder’s end-to-end AI/ML development services.
      </motion.p>
