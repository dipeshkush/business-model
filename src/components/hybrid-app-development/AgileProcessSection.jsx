        ...
        <section className="py-16 px-4 md:px-10 lg:px-20 text-center">
            ...
            <div className="max-w-2xl mx-auto flex flex-col space-y-6">
                {steps.map((step, index) => (
                    <div
                        key={index}
                        className="flex flex-col md:flex-row justify-between items-center w-full text-left"
                    >
                        {/* Left Part */}
                        {step.side === 'left' ? (
                            <>
                                <div className="w-full mr-2 md:w-1/2 flex justify-end">
                                    <div
                            ...
                            <>
                                <div className="w-full md:w-1/2 mr-2 flex justify-end mt-2 md:mt-0">
